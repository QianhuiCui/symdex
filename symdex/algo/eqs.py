...
@dataclass
class AgentSYMDEX(ActorCriticBase):
    def __post_init__(self):
        ...
        self.critic = cri_class(self.G, self.cfg.task.symmetry.SYMDEX.critic_input_fields[0], self.cfg.task.symmetry.SYMDEX.critic_output_fields[0], self.obs_dim[0], 1).to(self.cfg.device)
        self.critic_left = cri_class(self.G, self.cfg.task.symmetry.SYMDEX.critic_input_fields[1], self.cfg.task.symmetry.SYMDEX.critic_output_fields[1], self.obs_dim[1], 1).to(self.cfg.device)
        ...
        self.symmetry_manager = SymmetryManager(self.cfg.task.multi.SYMDEX, self.cfg.task.symmetry.symmetric_envs)
